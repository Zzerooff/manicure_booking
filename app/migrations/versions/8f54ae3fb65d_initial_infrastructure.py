...
Revision ID: 8f54ae3fb65d
Revises: 52bd5d38a694
Create Date: 2026-06-03 11:48:37.018777
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("available_slots", ARRAY(TIME), nullable=False),
